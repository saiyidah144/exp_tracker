...
class DiscretionaryExpensesRoute extends StatefulWidget {
 ...
 // final Expense expense;
  ...
  const DiscretionaryExpensesRoute({Key key, this.discretionary}) : super(key: key);
  @override
  _DiscretionaryExpensesRoute createState() => _DiscretionaryExpensesRoute();
}

class _DiscretionaryExpensesRoute extends State<DiscretionaryExpensesRoute> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Discretionary Expenses', style: TextStyle(fontSize: 30)),
      ),
                ...
                onPressed: () async {
                  if (_key.currentState.validate()) {
                    try {
                      ...
                      await db.collection("userData").document(uid).collection("expense").document(uid).collection("discretionary").add(discretionary.toJson());
