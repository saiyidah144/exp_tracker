...
class  TransportRoute extends StatefulWidget {
 ...
 // final Expense expense;
  ...
  const  TransportRoute({Key key, this.transport}) : super(key: key);
  @override
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Transport', style: TextStyle(fontSize: 30)),
      ),
                ...
                onPressed: () async {
                  if (_key.currentState.validate()) {
                    try {
                      ...
                      await db.collection("userData").document(uid).collection("expense").document(uid).collection("transportation").add(transport.toJson());
