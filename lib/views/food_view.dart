...
class FoodRoute extends StatefulWidget {
 ...
 // final Expense expense;
  ...
  const FoodRoute({Key key, this.food}) : super(key: key);
  @override
                ...
                onPressed: () async {
                  if (_key.currentState.validate()) {
                    try {
                      ...
                      await db.collection("userData").document(uid).collection("expense").document(uid).collection("food").add(food.toJson());
